...
public class SkeletonPatrol : Node
{
    private Transform _transform;
    private Animator _animator;
    private SkeletonWakeUp _wakeUp;
    ...
    public SkeletonPatrol(Transform transform, List<Transform> waypoints, EnemyController enemyController)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        if (_wakeUp == null)
        {
            _wakeUp = parent.GetChild<SkeletonWakeUp>();
        }
        else
        {
            if (_wakeUp._waiting)
